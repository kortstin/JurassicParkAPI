...
class DinosaursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dinosaur" do
    assert_difference('Dinosaur.count') do
      post dinosaurs_url, params: { dinosaur: { diet_type: @dinosaur.diet_type, name: @dinosaur.name, species: @dinosaur.species } }
    end
  ...
  test "should update dinosaur" do
    patch dinosaur_url(@dinosaur), params: { dinosaur: { diet_type: @dinosaur.diet_type, name: @dinosaur.name, species: @dinosaur.species } }
